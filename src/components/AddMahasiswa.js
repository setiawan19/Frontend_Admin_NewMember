            ...
            <div className="p-grid p-fluid">
                ...
                <div className="p-col-6">
                    <div className="card card-w-title">
                        ...
                        <div className="p-grid">
                            ...
                            <div className="p-col-12 p-md-12 form-group">
                                <InputText className="form-control" placeholder="Pekerjaan Orangtua" ref={ in_krj => this.pekerjaan_orangtua = in_krj }/>
                            </div>
                            <div className="p-col-12 p-md-12">
                                <label>Jenis Kelamin </label>
                                <div className="p-col-12 p-md-12 form-group">
                                    <RadioButton className="form-control" value="Laki-Laki" inputId="rb1" onChange={event => this.setState({jenis_kelamin: event.value})} checked={this.state.radioValue === "Laki-Laki"}/>
                                    <label htmlFor="rb1" className="p-radiobutton-label">Laki-Laki</label> &nbsp; &nbsp;
                                    <RadioButton className="form-control" value="Perempuan" inputId="rb2" onChange={event => this.setState({jenis_kelamin: event.value})} checked={this.state.radioValue === "Perempuan"}/>
                ...
                <div className="p-col-6">
                    <div className="card card-w-title">
                        <h4>Contact</h4>
                        <div className="p-col-12 p-md-12 form-group">
                            <InputText className="form-control" placeholder="Handphone" type="number" ref={ in_hp => this.no_hp = in_hp }/>
                        </div>
                        <div className="p-col-12 p-md-12 form-group">
                            <InputText className="form-control" placeholder="Email" type="email" ref={ in_email => this.email = in_email }/>
                        </div>
                    </div>
                </div>
                <div className="p-col-6">
                    <div className="card card-w-title">
                        ...
                        <div className="p-grid">
                            <div className="p-col-12 p-md-12 form-group">
                                <InputText className="form-control" placeholder="Asal Sekolah" ref={ in_sklh => this.asal_sekolah = in_sklh }/>
                            </div>
                            <div className="p-col-12 p-md-12 form-group">
                                <InputText className="form-control" placeholder="Jurusan SMA" ref={ in_jrsn => this.jurusan_sekolah = in_jrsn }/>
                            </div>
                            <div className="p-col-12 p-md-12 form-group">
                                <InputText className="form-control" placeholder="Nilai UN" type="number" ref={ in_nilai => this.nilai_UN = in_nilai }/>
                            </div>
                            <div className="p-col-12 p-md-12 form-group">
                                <InputText className="form-control" placeholder="Tahun Lulus SMA" type="number" ref={ in_smalulus => this.tahun_lulus = in_smalulus }/>
                            </div>
                            <div className="p-col-12 p-md-12 form-group">
                                <InputText className="form-control" placeholder="Tahun Masuk Kuliah" type="number" ref={ in_msk => this.tahun_masuk_kuliah = in_msk }/>
                            </div>   
                            <div className="p-col-12 p-md-12 form-group">
                                <Dropdown className="form-control" placeholder="Prodi" value="2" ref={ in_msk => this.id_prodi = in_msk }/>
                            </div>
                            <div className="p-col-12 p-md-12 form-group">
                ...
                <div className="p-col-12">
                    <div className="p-col-3">
                        <Button label="Save" icon="pi pi-plus" onClick={() => this.test()}/>
                    </div>
                </div>
